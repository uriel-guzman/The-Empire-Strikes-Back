...
\addfile{../Codes/Math/Factorial.cpp} 

\subsection{Factorial mod $smallPrime$} 
\addfile{../Codes/Math/Factorial mod small prime.cpp}
...
\addfile{../Codes/Math/Choose.cpp}
\vspace{-15pt}

\subsection{Catalan}
\addfile{../Codes/Math/Catalan.cpp}
...
\addfile{../Codes/Math/Factorial factors.cpp}