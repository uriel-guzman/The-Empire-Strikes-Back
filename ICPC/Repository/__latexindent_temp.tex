...
\lstdefinestyle{mine} {
	...
	morekeywords = [2] {
		...
		numeric_limits, bitset, array, string, iterator
	},
	morekeywords = [3] { 
		fore, LOCAL, ulli, LogN, 
		ull, lli, ld, ii,
		N, A, Q, B, C, D, H, K, F, T, P, V, 
		df, op, LLONG_MIN, LLONG_MAX, Args,
		ON, IN, OUT, OVERLAP, INF, BLOCK, EPS, LIM, PI
	},
	morekeywords = [4] { 
		Dsu, MonotoneQueue, Stack, Queue, Sparse, Query, StaticDynamic, Black, Range, 
		DisjointIntervals, Interval, ITree, CustomHash, OrderedTree, Fenwick, Dyn, Seg, Lazy, Per, Wav, Fun, LiChao, Treap, Node, Splay, 
		TwoSat, DynamicConnectivity, Dinic, Edge, Mcmf, HopcroftKarp, Hungarian, 
		Hash, Hashing, SuffixArray, SuffixAutomaton, AhoCorasick, Eertree, 
	...
	morekeywords = [6] {
		...
		emplace_front, top, push, push_back, push_front, pop, pop_back, pop_front, front, back, empty, resize, all, sz, rank, kth, 
