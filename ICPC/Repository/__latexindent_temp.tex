...
\subsection{Mo's algorithm \complexity{(N + Q) * \sqrt{N} * F} }
...
\subsection{Static to dynamic \complexity{N \cdot log N}}
...
\subsection{Treap}
\addfile[1-46]{../Codes/DataStructures/Treap.cpp}

\subsection{Implicit treap (Rope)}
\addfile[48-66]{../Codes/DataStructures/Treap.cpp}
