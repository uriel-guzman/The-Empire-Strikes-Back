...
\lstdefinestyle{mine} {
	...
	keywordstyle = [5]{\color{DarkBlue}},
	keywordstyle = [6]{\color{Red}},
	otherkeywords = {},
	morekeywords = {lli, ld, string, decltype, ostream, basic_ostream, done, fi, printf, constexpr, then, uint32_t},
	morekeywords = [2]{map, vector, function, queue, stack, set, multiset, pair, first, second, ordered_tree, deque, numeric_limits, bitset, unordered_tree},
	morekeywords = [3]{fore, LOCAL, ulli, ii, A, B, C, H, K, F, T, P, V, df},
	morekeywords = [4]{vi, Black, StaticDynamic, Range, DisjointIntervals, Sparse, Splay, RMQ, Dsu, MinQueue, Fenwick, LiChao, Seg, Lazy, Per, Wav, Dyn, Treap, Node, Edge,
	 EdmondsKarp, Dinic, Mcmf, HopcroftKarp, Hungarian, Hash, SuffixAutomaton, AhoCorasick, Eertree, ConvexHull, DynamicHull, Point, Trie, debug, Line, Fun, Query, Update, Point, rge, chash, SuffixArray, Args},
	...
	morekeywords = [6]{LL, NULL, inf, eps, lim, pi, eq, neq, geq, ge, le, leq},
}
