...
\lstdefinestyle{mine} {
	...
	otherkeywords = {},
	morekeywords = {
		lli, ld, decltype, ostream, basic_ostream, done, fi, printf, constexpr, then, uint32_t
	},
	morekeywords = [2] {
		map, vi, vector, function, queue, stack, set, multiset, pair, first, second, ordered_tree, deque, 
		numeric_limits, bitset, unordered_tree, array, string
	},
	morekeywords = [3] { 
		fore, LOCAL, ulli, ii, LogN, N, A, Q, B, C, H, K, F, T, P, V, df, op
	},
	morekeywords = [4] { 
		...
		Eertree, DynamicHull, Line, Pt, Cir, Poly, Radial, Update
	},
	morekeywords = [5] {
		...
		__builtin_bswap64, cos, sin, sqrtl, acos, min, max, abs, fabs, hypot, lower_bound, upper_bound, iterator, lsb, __lg, gcd, lcm, 
		make_pair, uniform_int_distribution, sort, unite, rollback, qwho, qsum, qmax, qmin, add, rem, update, query, pull, push, build, 
		kth, qsz, split, merge, splitsz, fun, run, go, test, random, diff, open, dot, cross, perp, norm, length, angle, unit, rotate,
		cuad, contains, intersects, intersection, parallel, projection, reflection, inside, outside, tangency, get, cmp, rank, pos, 
		either, implies, setVal, solve
	},
	morekeywords = [6]{
