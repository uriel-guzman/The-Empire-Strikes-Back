\documentclass[3pt, twocolumn, letterpaper, notitlepage, fleqn]{article} % Vertical way
...
\def\title{Universidad de Guadalajara CUCEI - Almost Retired}


% % header 
% \setlength{\headsep}{0cm} % Adjusting header separation
\fancyhf{} % Limpiar las cabeceras y pies de página
\pagestyle{fancy}
\fancyheadoffset[R]{0cm} % Desplazar el encabezado hacia la derecha
\fancyhead[L]{\small \textbf{\title}}
\fancyhead[C]{} % No hay nada en el centro
\fancyhead[R]{\hfill\thepage} % Encabezado en el lado derecho
\renewcommand{\headrulewidth}{0pt} % Ancho de la línea de encabezado
\setlength{\headsep}{0pt} % Eliminar el espacio entre el encabezado y el contenido

% Adjusting the header
% \renewcommand{\headrulewidth}{0pt} % Removing header rule
...
\lstdefinestyle{mine} {
    ...
    morekeywords = [4] { 
        ...
        DisjointIntervals, Interval, ITree, CustomHash, OrderedTree, Fenwick, Dyn, Seg, Lazy, Per, Wav, Fun, LiChao, Treap, PerTreap, Node, Splay, Mat, LinkCut,
        ...
        XorBasis, Num, Berlekamp, Lagrange, FFT, NTT, FWHT, Modular, Big, Blossom,
        Mint, DynamicConnectivity, Frac
    },
	morekeywords = [5] { 
		ulli, ull, lli, ld, ii, 
	},
